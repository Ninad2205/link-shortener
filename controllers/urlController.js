...
exports.createShortUrl = async (req, res) => {
  ...
  // if (existingUrl) {
  //     return res.render("index", {
  //         shortUrl: `https://ninad.at/${existingUrl.shortUrl}`,
  ...
  if (existingUrl) {
    return res.render("index", {
      shortUrl: `https://link-mint.vercel.app/${existingUrl.shortUrl}`,
      actualLink: `https://link-mint.vercel.app/${existingUrl.shortUrl}`,
      error: null,
    });
  }
